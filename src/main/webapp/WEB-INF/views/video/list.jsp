		...
		$("#admin-delete-btn").click(function(){
			...
			swal({
				...
				if (isConfirm) {
					...
					location.href = "/board/video/deletes?nums=" + deleteNums;
				} else {
			        	...
			        	<c:forEach items="${boardList}" var="boardDTO" varStatus="status">
			        		...
			        		<a href="${href }" class="list-group-item">
			                	<div class="col-md-9" style="margin-top: 2%">
				                    <h4 class="list-group-item-heading" style="display: inline-block; text-overflow:ellipsis; white-space: nowrap; overflow: hidden; max-width: 750px;">${boardDTO.subject}</h4>
