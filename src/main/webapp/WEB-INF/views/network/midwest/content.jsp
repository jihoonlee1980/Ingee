...
<script type="text/javascript">
				...
				$(document).on("click", ".updateBtn", function(){
					...
					swal({
						...
						if (isConfirm) {
							...
							location.href = "/comment/network/midwest/update?num=" + num + "&content=" + new_content + "&board_num=" + board_num + "&page=" + page;
						} else {
	...
	function getReply(obj, board_num, comment_num, isLogin, loginNick, loggedInProfile, board_writer, page){
		if($(obj).hasClass("active")){
			...
			if(isLogin != ""){
				html += "<li>";
				html += "<form action='/comment/network/midwest/insert' class='reply-input' method='get'>";
					...
					<div class="content-div" style="width: 100%; text-align: right;">
       				...
       				<div class="row" style="margin-top:65px; padding-left: 5px;">
						...
						<c:if test="${isLogin ne null }">
							<form action="/comment/network/midwest/insert" class="comment-input" method="get">
		...
		<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="well well-sm">
					<form class="form-horizontal" action="/board/network/midwest/update" method="post" enctype="multipart/form-data">
						<fieldset>
