			        	...
			        	<c:forEach items="${boardList}" var="boardDTO" varStatus="status">
			        		...
			        		<a href="${href }" class="list-group-item">
			                	...
			                	<div class="col-md-${boardDTO.saved_filename != 'NO' ? 6 : 9}" style="margin-top: 2%">
				                    ...
				                    <h4 class="list-group-item-heading" style="display: inline-block; text-overflow:ellipsis; white-space: nowrap; overflow: hidden; max-width: 500px;"><span style="font-size: 10pt; font-weight: 600; color: #e69b0b">[${fn:toUpperCase(s_category) }]&nbsp;&nbsp;&nbsp;</span>${boardDTO.subject}</h4>
