		...
		$("#admin-delete-btn").click(function(){
			...
			swal({
				...
				if (isConfirm) {
					...
					location.href = "/board/network/south/deletes?nums=" + deleteNums;
				} else {
		...
		<div class="modal fade" id="write" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="well well-sm">
					<form class="form-horizontal" action="/board/network/south/insert" method="post" enctype="multipart/form-data" onsubmit="return boardInsert();">
						<fieldset>
