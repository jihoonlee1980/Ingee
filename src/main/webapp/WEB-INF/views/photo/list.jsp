		...
		$("#admin-delete-btn").click(function(){
			...
			swal({
				...
				if (isConfirm) {
					...
					location.href = "/board/photo/deletes?nums=" + deleteNums;
				} else {
						...
						<fieldset>
							...
							<div class="form-group">
								<div class="input-group">
									...
									<div class="col-md-9">
										<input type="file" class="form-control" name="upload_file" id="upload_file" required="required" accept=".png, .jpg, .jpeg, .bmp, .gif" onchange="validateFile(this)">
